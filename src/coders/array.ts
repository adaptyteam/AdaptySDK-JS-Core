...
export class ArrayCoder<Model, Serializable> implements Converter<Model[], Serializable[]> {
  constructor(private readonly coderFactory: () => Converter<Model, Serializable>) {}
